                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('C_arqAuth/register') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <button href="<?= base_url('C_arqAuth') ?>" type="submit" class="btn btn-dark btn-user btn-block">
                                    Register Account
                                </button>               
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= base_url('C_arqAuth') ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
