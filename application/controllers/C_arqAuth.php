...
class C_arqAuth extends CI_Controller

{
...

    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/V_arqSetup', $data);
            ...
            redirect('C_arqAuth/login_admin');
...

    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/V_arqAdmin');
...

    {
        ...
        $this->M_arqAdmin->insertpetugas($data);
